  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <div class="container"><a class="navbar-brand" href="Index.php"><img src="img/LogoIndex.png" height="120" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
              <li class="nav-item"><a class="nav-link" aria-current="page" href="Management.php">Home</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#feature">Course </a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="AddCourse.php">Add Course </a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#validation">Teacher </a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#manager">Book</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#marketing">Syllabus</a></li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-md-start text-center py-6">
              ...
              <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="Register.php" role="button">Get started</a><a class="btn btn-link text-warning fw-medium" href="#!" role="button" data-bs-toggle="modal" data-bs-target="#popupVideo"><span class="fas fa-play me-2"></span>Watch the video </a></div>
            </div>
            <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="img/hero/hero-img.png" alt="" /></div>
          </div>
        </div>
      </section>
      ...
      <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block" style="background-image:url(img/category/shape.png);opacity:.5;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <h1 class="fs-9 fw-bold mb-4 text-center"> We provide courses that support <br class="d-none d-xl-block" />your future growth</h1>
          <div class="row">
          ...
          <div class="text-center"><a class="btn btn-warning" href="Course.php" role="button">View All </a></div>
      ...
      <section class="pt-5" id="validation">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="img/validation/validation.png" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="pt-5" id="manager">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6"><img class="img-fluid" src="img/manager/manager.png" alt="" /></div>
            <div class="col-lg-6">
              ...
              <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="img/manager/tick.png" width="35" alt="tick" />
      ...
      <section class="pt-5" id="marketer">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="img/marketer/marketer.png" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="py-md-11 py-8" id="superhero">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block background-position-top" style="background-image:url(img/superhero/oval.png);opacity:.5; background-position: top !important ;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="img/marketing/marketing01.png" alt="" />
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="img/marketing/marketing02.png" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="img/marketing/marketing03.png" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
          ...
          <div class="container border-top py-3">
            <div class="row justify-content-between">
              <div class="col-12 col-md-auto mb-1 mb-md-0">
                <p class="mb-0">&copy; 2023 Your Company Inc </p>
              </div>
    ...
    <div class="modal fade" id="popupVideo" tabindex="-1" aria-labelledby="popupVideo" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          <iframe class="rounded" style="width:100%;height:500px;" src="#" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  <!-- ===============================================-->
